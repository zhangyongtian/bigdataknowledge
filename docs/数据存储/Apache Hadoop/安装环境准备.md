...
192.168.61.200 master1
192.168.61.201 master2
192.168.61.202 hadoop1
192.168.61.203 hadoop2
192.168.61.204 hadoop3
```
...
```
chmod 744 /home/bigdata/shell/xsync.sh
...
#2. 遍历集群所有机器
for host in master1 master2 hadoop1 hadoop2 hadoop3
do
  echo ====================  $host  ====================
  #3. 遍历所有目录，挨个发送
  for file in $@
