...
**快速体验的话就直接用官网的在线安装就行了，如果访问web出错，那么就查看一下docker的日志**
...
VOLUME_DIR=/data/app/jumpserver/jumpserver-offline-installer-v3.10.3-amd64/data
LOG_LEVEL=ERROR
...
cd jumpserver-offline-release-v3.10.3-amd64
